...
public class SettingsActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab = actionBar
                ...
                .setTabListener(
                        new TabListener<ServersFragment>(this, "servers", ServersFragment.class));
        ...
        tab = actionBar
                ...
                .setTabListener(
                        new TabListener<PersonalInfoFragment>(this, "personalInfo",
     ...
     * http://developer.android.com/guide/topics/ui/actionbar.html#Tabs This
     * version has been slightly modified to work with Sherlock
     */
    public static class TabListener<T extends Fragment> implements ActionBar.TabListener {
         ...
         * 
         * @param settingsActivity The host Activity, used to instantiate the
         *            fragment
