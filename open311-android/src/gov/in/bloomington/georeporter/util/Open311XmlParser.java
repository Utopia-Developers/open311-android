...
public class Open311XmlParser {
     ...
     * @throws JSONException
     */
    public JSONObject parseServiceDefinition(String xml) throws XmlPullParserException,
     ...
     * @throws JSONException
     */
    private JSONArray parseServices(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
     ...
     * @throws JSONException
     */
    private JSONObject parseServiceDefinition(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
     ...
     * @throws JSONException
     */
    private JSONObject parseService(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (name.equals(Open311.SERVICE_CODE)) {
                ...
                jo.put(Open311.METADATA,
                        Boolean.parseBoolean(readElement(parser, Open311.METADATA)));
            }
            else {
                skip(parser);
            }
     ...
     * @throws JSONException
     */
    private JSONArray parseAttributes(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
     ...
     * @throws JSONException
     */
    private JSONObject parseAttribute(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (name.equals(Open311.DATATYPE)) {
                ...
                jo.put(Open311.VARIABLE,
                        Boolean.parseBoolean(readElement(parser, Open311.VARIABLE)));
            }
            else if (name.equals(Open311.REQUIRED)) {
                jo.put(Open311.REQUIRED,
                        Boolean.parseBoolean(readElement(parser, Open311.REQUIRED)));
            }
     ...
     * @throws JSONException
     */
    private JSONArray parseRequests(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
        JSONArray ja = new JSONArray();
     ...
     * @throws JSONException
     */
    private JSONObject parseRequest(XmlPullParser parser) throws XmlPullParserException,
            IOException, JSONException {
