...
public class Preferences {
	 ...
	 * 
	 * This should always return a valid JSONObject. The JSONObject may be
	 * empty, but it needs to be ready for the user to start filling out the
	 * fields.
	 * 
	 * @param c
	 * @return JSONObject
	 ...
	 * 
	 * Users can add additional servers to the settings. These additional server
	 * definitions will be stored as JSON strings in settings.
	 * 
	 * @param c
	 * @return JSONArray
	 */
	 ...
	 * 
	 * Server definitions will change over time, and we always want to use the
	 * latest defintion of each server. Check for the server by name and fully
